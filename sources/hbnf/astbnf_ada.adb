...
package body ASTBNF_Ada is
   ...
   begin
      ...
      Append (Bdy, "   function Lex (Text : String) return Token_Vectors.Vector is");
      Append (Bdy, LF);
      Append (Bdy, "      Toks : Token_Vectors.Vector;");
      Append (Bdy, LF);
      Append (Bdy, "      I    : Natural := Text'First;");
      Append (Bdy, LF);
      Append (Bdy, "      Line : Natural := 1;");
      Append (Bdy, LF);
      Append (Bdy, "      Col  : Natural := 1;");
      Append (Bdy, LF);
      Append (Bdy, "      C    : Character;");
      Append (Bdy, LF);
      Append (Bdy, "   begin");
      Append (Bdy, LF);
      Append (Bdy, "      while I <= Text'Last loop");
      Append (Bdy, LF);
      Append (Bdy, "         C := Text (I);");
      Append (Bdy, LF);
      Append (Bdy, "         if C = ' ' or else C = ASCII.HT or else C = ASCII.CR then");
      Append (Bdy, LF);
      Append (Bdy, "            I := I + 1; Col := Col + 1;");
      Append (Bdy, LF);
      Append (Bdy, "         elsif C = ASCII.LF then");
      Append (Bdy, LF);
      Append (Bdy, "            I := I + 1; Line := Line + 1; Col := 1;");
      Append (Bdy, LF);
      Append (Bdy, "         elsif C = '#' then");
      Append (Bdy, LF);
      Append (Bdy, "            while I <= Text'Last and then Text (I) /= ASCII.LF loop");
      Append (Bdy, LF);
      Append (Bdy, "               I := I + 1;");
      Append (Bdy, LF);
      Append (Bdy, "            end loop;");
      ...
      Append (Bdy, "            declare");
      Append (Bdy, LF);
      Append (Bdy, "               SC  : constant Natural := Col;");
      Append (Bdy, LF);
      Append (Bdy, "               Buf : Unbounded_String;");
      Append (Bdy, LF);
      Append (Bdy, "            begin");
      Append (Bdy, LF);
      Append (Bdy, "               I := I + 1; Col := Col + 1;");
      Append (Bdy, LF);
      Append (Bdy, "               while I <= Text'Last and then Text (I) /= '""' loop");
      Append (Bdy, LF);
      Append (Bdy, "                  if Text (I) = '\' and then I < Text'Last then");
      Append (Bdy, LF);
      Append (Bdy, "                     I := I + 1; Col := Col + 1;");
      Append (Bdy, LF);
      Append (Bdy, "                  end if;");
      Append (Bdy, LF);
      Append (Bdy, "                  Append (Buf, Text (I));");
      Append (Bdy, LF);
      Append (Bdy, "                  I := I + 1; Col := Col + 1;");
      Append (Bdy, LF);
      Append (Bdy, "               end loop;");
      Append (Bdy, LF);
      Append (Bdy, "               if I <= Text'Last then");
      Append (Bdy, LF);
      Append (Bdy, "                  I := I + 1; Col := Col + 1;");
      Append (Bdy, LF);
      Append (Bdy, "               end if;");
      Append (Bdy, LF);
      Append (Bdy, "               Toks.Append (Token'(Str, Buf, Line, SC));");
      Append (Bdy, LF);
      Append (Bdy, "            end;");
      Append (Bdy, LF);
      Append (Bdy, "         elsif C in '0' .. '9' then");
      Append (Bdy, LF);
      Append (Bdy, "            declare");
      Append (Bdy, LF);
      Append (Bdy, "               SC  : constant Natural := Col;");
      Append (Bdy, LF);
      Append (Bdy, "               Is_Dec : Boolean := False;");
      Append (Bdy, LF);
      Append (Bdy, "               Buf : Unbounded_String;");
      Append (Bdy, LF);
      Append (Bdy, "            begin");
      Append (Bdy, LF);
      Append (Bdy, "               while I <= Text'Last and then Text (I) in '0' .. '9' loop");
      Append (Bdy, LF);
      Append (Bdy, "                  Append (Buf, Text (I)); I := I + 1; Col := Col + 1;");
      Append (Bdy, LF);
      Append (Bdy, "               end loop;");
      Append (Bdy, LF);
      Append (Bdy, "               if I < Text'Last and then Text (I) = '.' and then Text (I + 1) in '0' .. '9' then");
      Append (Bdy, LF);
      Append (Bdy, "                  Is_Dec := True;");
      Append (Bdy, LF);
      Append (Bdy, "                  Append (Buf, '.'); I := I + 1; Col := Col + 1;");
      Append (Bdy, LF);
      Append (Bdy, "                  while I <= Text'Last and then Text (I) in '0' .. '9' loop");
      Append (Bdy, LF);
      Append (Bdy, "                     Append (Buf, Text (I)); I := I + 1; Col := Col + 1;");
      ...
      Append (Bdy, "               end if;");
      Append (Bdy, LF);
      Append (Bdy, "               if I <= Text'Last and then (Text (I) = 'e' or else Text (I) = 'E') then");
      Append (Bdy, LF);
      Append (Bdy, "                  Is_Dec := True;");
      Append (Bdy, LF);
      Append (Bdy, "                  Append (Buf, Text (I)); I := I + 1; Col := Col + 1;");
      Append (Bdy, LF);
      Append (Bdy, "                  if I <= Text'Last and then (Text (I) = '+' or else Text (I) = '-') then");
      Append (Bdy, LF);
      Append (Bdy, "                     Append (Buf, Text (I)); I := I + 1; Col := Col + 1;");
      Append (Bdy, LF);
      Append (Bdy, "                  end if;");
      ...
      Append (Bdy, "               end if;");
      Append (Bdy, LF);
      Append (Bdy, "               Toks.Append (Token'((if Is_Dec then Dec else Int), Buf, Line, SC));");
      Append (Bdy, LF);
      Append (Bdy, "            end;");
      Append (Bdy, LF);
      Append (Bdy, "         elsif C in 'a' .. 'z' or else C in 'A' .. 'Z' or else C = '_' or else C = '-' then");
      Append (Bdy, LF);
      Append (Bdy, "            declare");
      Append (Bdy, LF);
      Append (Bdy, "               SC  : constant Natural := Col;");
      ...
      Append (Bdy, "                  C := Text (I);");
      Append (Bdy, LF);
      Append (Bdy, "                  exit when not (C in 'a' .. 'z' or else C in 'A' .. 'Z'");
      Append (Bdy, LF);
      Append (Bdy, "                    or else C in '0' .. '9' or else C = '_' or else C = '-'");
      Append (Bdy, LF);
      Append (Bdy, "                    or else C = '.');");
      Append (Bdy, LF);
      Append (Bdy, "                  Append (Buf, C); I := I + 1; Col := Col + 1;");
      Append (Bdy, LF);
      Append (Bdy, "               end loop;");
      Append (Bdy, LF);
      Append (Bdy, "               Toks.Append (Token'(Atom, Buf, Line, SC));");
      Append (Bdy, LF);
      Append (Bdy, "            end;");
      Append (Bdy, LF);
      Append (Bdy, "         else");
      ...
      Append (Bdy, "            begin");
      Append (Bdy, LF);
      Append (Bdy, "               Append (Buf, C);");
      Append (Bdy, LF);
      Append (Bdy, "               Toks.Append (Token'(Punct, Buf, Line, Col));");
      Append (Bdy, LF);
      Append (Bdy, "               I := I + 1; Col := Col + 1;");
      Append (Bdy, LF);
      Append (Bdy, "            end;");
      ...
      Append (Bdy, "      end loop;");
      Append (Bdy, LF);
      Append (Bdy, "      Toks.Append (Token'(Eof, Null_Unbounded_String, Line, Col));");
      Append (Bdy, LF);
      Append (Bdy, "      return Toks;");
      Append (Bdy, LF);
      Append (Bdy, "   end Lex;");
      Append (Bdy, LF);
      Append (Bdy, LF);

      --  Convenience: lex, split text into lines (for the caret), parse.
      Append (Bdy, "   function Parse_Text (Text : String) return " & Ret_Type (1) & " is");
      Append (Bdy, LF);
      Append (Bdy, "      Toks  : Token_Vectors.Vector := Lex (Text);");
      Append (Bdy, LF);
      Append (Bdy, "      Lines : Line_Vectors.Vector;");
      Append (Bdy, LF);
      Append (Bdy, "      S     : Natural := Text'First;");
      Append (Bdy, LF);
      Append (Bdy, "   begin");
      Append (Bdy, LF);
      Append (Bdy, "      for K in Text'Range loop");
      Append (Bdy, LF);
      Append (Bdy, "         if Text (K) = ASCII.LF then");
      Append (Bdy, LF);
      Append (Bdy, "            Lines.Append (To_Unbounded_String (Text (S .. K - 1)));");
      Append (Bdy, LF);
      Append (Bdy, "            S := K + 1;");
      Append (Bdy, LF);
      Append (Bdy, "         end if;");
      ...
      Append (Bdy, "      end loop;");
      Append (Bdy, LF);
      Append (Bdy, "      Lines.Append (To_Unbounded_String (Text (S .. Text'Last)));");
      Append (Bdy, LF);
      Append (Bdy, "      declare");
      Append (Bdy, LF);
      Append (Bdy, "         P : Parser := (Toks => Toks, Lines => Lines, Pos => 1);");
